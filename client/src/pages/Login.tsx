  ...
  return (
    <main className="w-full h-[100dvh] flex">
      <div className="bg-red w-full flex flex-col justify-center items-center gap-3">
        ...
        <InputField id='email' placeholder='Digite seu email' type='text' value={email} onChange={(event) => setEmail(event.target.value)} label='Email' />
        <InputField id='senha' placeholder='Digite sua senha' type='password' value={password} onChange={(event) => setPassword(event.target.value)} label='Senha' />
        {
